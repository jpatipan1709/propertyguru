                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right">
                                        {{-- <a href="{{ url('event').'/create' }}" class="btn btn-inverse btn-outline-inverse">Add
                                            Event</a> --}}
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <div>
                                                    ...
                                                    <input type="checkbox" name="final_project" id="final_project" class="js-single" 
                                                    @if (old('final_project') != "")
                                                        {{'checked'}}
                                                    @endif 
