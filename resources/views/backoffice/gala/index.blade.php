                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <br>
                                    <form action="{{url('gala')}}" method="post" autocomplete="off" enctype="multipart/form-data"
                                        ...
                                        <div class="form-row justify-content-md-center">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div id="image-preview">
                                                    ...
                                                    <img style="width:300px;height:300px;" src="{{ count($tickets) >= 1 ?  url('storage/gala/'.$tickets[0]->gl_images) : '' }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="hidden" class="form-control" name="width_box5" id="width_box5"
                                                    value="{{ count($tickets) >= 1 ? $tickets[0]->gl_text_x	: '' }}"
                                                    required readonly>
                                            </div>
                                            <div class="form-group col-md-3">
                                                {{-- <label for="heigth_box3">Left Company :</label> --}}
                                                <input type="hidden" class="form-control" name="heigth_box5" id="heigth_box5"
                                                    value="{{ count($tickets) >= 1 ? $tickets[0]->gl_text_y: '' }}"
                                                    required readonly>
                                            </div>

                                            <div class="form-group col-md-3">
                                                {{-- <label for="width_box4">Top QR CODE :</label> --}}
                                                <input type="hidden" class="form-control" name="width_box6" id="width_box6"
                                                    value="{{ count($tickets) >= 1 ? $tickets[0]->gl_image_x: '' }}"
                                                    readonly readonly>
                                            </div>
                                            <div class="form-group col-md-3">
                                                {{-- <label for="heigth_box4">Left QR CODE :</label> --}}
                                                <input type="hidden" class="form-control" name="heigth_box6" id="heigth_box6"
                                                    value="{{ count($tickets) >= 1 ? $tickets[0]->gl_image_y: '' }}"
                                                    required readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <textarea type="text"  id="text_content" class="form-control  {{ $errors->has('text_content') ? ' is-invalid' : '' }}"
                                                    name="text_content" >{{ count($tickets) >= 1 ? $tickets[0]->gl_text: '' }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" id="text-field" id="border_pick" class="form-control demo {{ $errors->has('border_pick') ? ' is-invalid' : '' }}"
                                                    name="border_pick" value="{{ count($tickets) >= 1 ? $tickets[0]->gl_color: '#000000' }}">
                                            </div>
                                            <div class="form-group" style="margin-left:25px;">
                                                <label for=""><b>Font Size</b></label>
                                                <select name="font_size" id="font_size" class="form-control">
                                                    <option value="10"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 10 ? 'selected' : '')  : ''  }}>10</option>
                                                    <option value="14"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 14 ? 'selected' : '')  : ''  }}>14</option>
                                                    <option value="16"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 16 ? 'selected' : '')  : ''  }}>16</option>
                                                    <option value="18"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 18 ? 'selected' : '')  : ''  }}>18</option>
                                                    <option value="20"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 20 ? 'selected' : '')  : ''  }}>20</option>
                                                    <option value="22"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 22 ? 'selected' : '')  : ''  }}>22</option>
                                                    <option value="24"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 24 ? 'selected' : '')  : ''  }}>24</option>
                                                    <option value="26"
                                                        {{ (count($tickets) >= 1) ? ($tickets[0]->gl_size == 26 ? 'selected' : '')  : ''  }}>26</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-7 text-right">
                                                ...
                                                {{-- <a href="{{url('PreviewBadge')}}" class="btn btn-primary">Preview
                                                    Badge</a> --}}
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div id="canvas">
                                            ...
                                            <div id="box" style="{{ count($tickets) >= 1 ? 'left:'.$tickets[0]->gl_name_y.'px;'.'top:'.$tickets[0]->gl_name_x.'px;font-size:'.$tickets[0]->gl_size.'px;color:'.$tickets[0]->gl_color : '' }}">
                                                [PersonFirstName]</div>
                                            <div id="box1" style="{{ count($tickets) >= 1 ? 'left:'.$tickets[0]->gl_lastname_y.'px;'.'top:'.$tickets[0]->gl_lastname_x.'px;'.'px;font-size:'.$tickets[0]->gl_size.'px;color:'.$tickets[0]->gl_color : '' }}">
                                                [PersonLastName]</div>
                                            <div id="box2" style="{{ count($tickets) >= 1 ? 'left:'.$tickets[0]->gl_company_y.'px;'.'top:'.$tickets[0]->gl_company_x.'px;'.'px;font-size:'.$tickets[0]->gl_size.'px;color:'.$tickets[0]->gl_color : '' }}">
                                                [CompanyName]</div>
                                            <div id="box3" style="{{ count($tickets) >= 1 ? 'left:'.$tickets[0]->gl_table_y.'px;'.'top:'.$tickets[0]->gl_table_x.'px;'.'px;font-size:'.$tickets[0]->gl_size.'px;color:'.$tickets[0]->gl_color : '' }}">
                                                [Tablename] </div>
                                            <div id="box4" style="{{ count($tickets) >= 1 ? 'left:'.$tickets[0]->gl_text_y.'px;'.'top:'.$tickets[0]->gl_text_x.'px;'.'px;font-size:'.$tickets[0]->gl_size.'px;color:'.$tickets[0]->gl_color : '' }}">
                                                [Text]</div>
                                            <div id="box5" style="{{ count($tickets) >= 1 ? 'left:'.$tickets[0]->gl_image_y.'px;'.'top:'.$tickets[0]->gl_image_x.'px;'.'px;font-size:'.$tickets[0]->gl_size.'px;color:'.$tickets[0]->gl_color : '' }}">
                                                [Images]</div>
                                        </div>
...
<script>
    ...
    $('#get_form').click(function () {
        ...
        $('#width_box6').val(box6.top);
        $('#heigth_box6').val(box6.left);
