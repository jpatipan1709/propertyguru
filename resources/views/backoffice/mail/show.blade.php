                                        ...
                                        <form action="{{ url('email',$id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row justify-content-md-center">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    {{-- <div id="image-preview">
                                                            <img  src="{{ (isset($mails->tbm_logo) ? url('storage/email/'. $mails->tbm_logo) : '' )   }}" style="width:300px;height: 300px;" class="img-responsive" class="image"/>
                                                        <label for="image-upload" id="image-label">Upload Logo</label>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea ype="text" class="form-control" id="content" name="content"
                                                        placeholder="Content E-mail" autocomplete="off" required>{{ ( isset($mails->tbm_content) ?  $mails->tbm_content : '') }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <form action="{{ url('email') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label for="content">Content E-mail</label>
                                                    <textarea ype="text" class="form-control" id="content" name="content"
                                                        placeholder="Content E-mail" autocomplete="off" required></textarea>
                                                </div>
                                            </div>
